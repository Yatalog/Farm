...
-- Запускаем функцию при добавлении персонажа
player.CharacterAdded:Connect(startCollectingCoins)

-- Запускаем функцию для текущего персонажа (если он уже существует)
